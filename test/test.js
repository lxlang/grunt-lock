...
describe('matching tasks', function() {
  it('Test matches function using minimatch', function() {
  ...
  it('check for matching allowed Tasks', function() {
    var patterns = ['foo*','*bar','baz'];
  ...
  it('check for matching ignored Tasks', function() {
    var patterns = ['foo*','*bar','baz'];
...
describe('normalizing the taskArrays', function() {
  it('Normalize task Array', function() {
...
describe('create lockfile and check for data', function() {
  var path = 'foobar.lck';
  it('create lockfile', function() {
    lockFileExtendedLib.createLock({path: path})
    assert.equal(fs.existsSync(path), true);
  });
  
  it('check lockfile contents', function() {
